...
class GreenLeavesHome extends StatefulWidget {
  const GreenLeavesHome({Key? key}) : super(key: key);

  @override
  _GreenLeavesHomeState createState() => _GreenLeavesHomeState();
}

class _GreenLeavesHomeState extends State<GreenLeavesHome> {
  @override
  Widget build(BuildContext context) {
    var deviceWidth = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text('පලා බෝග වගාව'),
          leading: IconButton(
