...
class PumpkinHome extends StatefulWidget {
  const PumpkinHome({Key? key}) : super(key: key);

  @override
  _PumpkinHomeState createState() => _PumpkinHomeState();
}

class _PumpkinHomeState extends State<PumpkinHome> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Pumpkin Home'),
        ),
        body: Container(
                ...
                child:  Column(
                  children: [
                    ...
                    ListTile(
                      ...
                      onTap: (){ Navigator.push(context, MaterialPageRoute(builder: (context)=>PumpkinFarming()));},
                    ),
                    ListTile(
                      title:  Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                      ...
                      onTap: (){ Navigator.push(context, MaterialPageRoute(builder: (context)=>PumpkinHarvest()));},
                    ),
                    ListTile(
                      title:  Row(
                        mainAxisAlignment: MainAxisAlignment.center,
